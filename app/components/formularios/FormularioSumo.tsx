...
interface SumoData {
  ...
  equipo1: string;
  equipo2: string;
  penalizaciones1: PenalizacionesSumo;
  penalizaciones2: PenalizacionesSumo;
  ganador: string;
  victoriaMotivo: string;
  observaciones: string;
}

interface FormularioSumoProps {
  sumoData: SumoData;
  setSumoData: React.Dispatch<React.SetStateAction<SumoData>>;
  onReset: () => void;
}

export const FormularioSumo: React.FC<FormularioSumoProps> = ({
  sumoData,
  setSumoData,
  onReset,
}) => {
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              setSumoData({ ...sumoData, round: e.target.value })
            }
            ...
            <div className="card border-primary">
              ...
              <div className="card-body">
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setSumoData({ ...sumoData, equipo1: e.target.value })
                  }
                ...
                <div className="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div className="btn-group">
                      ...
                      onClick={() =>
                        setSumoData({
                          ...
                          penalizaciones1: {
                            ...
                            salidaFalsa: Math.max(
                              0,
                              sumoData.penalizaciones1.salidaFalsa - 1,
                            ),
                          },
                        })
                      }
                    ...
                    <span className="btn btn-sm btn-light disabled">
                      {sumoData.penalizaciones1.salidaFalsa}/3
                    </span>
                    <button
                      onClick={() =>
                        setSumoData({
            ...
            <div className="card border-danger">
              ...
              <div className="card-body">
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setSumoData({ ...sumoData, equipo2: e.target.value })
                  }
                  className="form-control mb-3"
                  placeholder="Nombre del equipo"
                />
                ...
                <div className="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div className="btn-group">
                      ...
                      onClick={() =>
                        setSumoData({
                          ...
                          penalizaciones2: {
                            ...
                            salidaFalsa: Math.max(
                              0,
                              sumoData.penalizaciones2.salidaFalsa - 1,
                            ),
                          },
                        })
                      }
                    ...
                    <span className="btn btn-sm btn-light disabled">
                      {sumoData.penalizaciones2.salidaFalsa}/3
                    </span>
                    <button
                      onClick={() =>
                        setSumoData({
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
              setSumoData({ ...sumoData, victoriaMotivo: e.target.value })
            }
          ...
          >
            ...
            <option value="descalificacion">
              Descalificación o 3 advertencias
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
              setSumoData({ ...sumoData, observaciones: e.target.value })
            }
            className="form-control"
            rows={3}
