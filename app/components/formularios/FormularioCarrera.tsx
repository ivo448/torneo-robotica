...
import type { Intento } from "~/utils/helpers";
...
interface FormularioCarreraProps {
  ...
  setCarreraData: React.Dispatch<React.SetStateAction<CarreraData>>;
  onReset: () => void;
}

export const FormularioCarrera: React.FC<FormularioCarreraProps> = ({
  carreraData,
  setCarreraData,
  onReset,
}) => {
      ...
      <div className="card-body">
        <div className="mb-4">
          ...
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              setCarreraData({ ...carreraData, equipo: e.target.value })
            }
        ...
        <div className="mb-4">
          ...
          <div className="alert alert-info">
            ...
            {getMejorTiempo(carreraData.intentos as Intento[])} segundos
          </div>
        </div>
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="btn-group">
                      ...
                      setCarreraData({
                        ...
                        penalizaciones: {
                          ...
                          salidaFalsa: Math.max(
                            0,
                            carreraData.penalizaciones.salidaFalsa - 1,
                          ),
                        },
                      })
                    }
                  ...
                  <span className="btn btn-sm btn-light disabled">
                    {carreraData.penalizaciones.salidaFalsa}
                  </span>
                  <button
                    onClick={() =>
                      setCarreraData({
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="btn-group">
                  <button
                    onClick={() =>
                      setCarreraData({
                        ...
                        penalizaciones: {
                          ...carreraData.penalizaciones,
                          salidaPista: Math.max(
                            0,
                            carreraData.penalizaciones.salidaPista - 1,
                          ),
                        },
                      })
                    }
                  ...
                  <span className="btn btn-sm btn-light disabled">
                    {carreraData.penalizaciones.salidaPista}
                  </span>
                  <button
                    onClick={() =>
                      setCarreraData({
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="btn-group">
                    ...
                    onClick={() =>
                      setCarreraData({
                        ...
                        penalizaciones: {
                          ...
                          noCompleto: Math.max(
                            0,
                            carreraData.penalizaciones.noCompleto - 1,
                          ),
                        },
                      })
                    }
                  ...
                  <span className="btn btn-sm btn-light disabled">
                    {carreraData.penalizaciones.noCompleto}
                  </span>
                  <button
                    onClick={() =>
                      setCarreraData({
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
              setCarreraData({ ...carreraData, observaciones: e.target.value })
            }
            className="form-control"
            rows={3}
